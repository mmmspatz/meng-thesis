...
Of the noise sources that we can control, the first amplifier in the signal processing chain is most critical. It's
...
\begin{figure}
    ...
    \caption{Two port noise model for amplifier with gain $G$.}
...
\begin{equation}\label{eq:2port_noisefactor_3}
    F = \frac{\bar{i_s^2} + \bar{i_u^2} + |Y_S + Y_C|^2 \bar{e_n^2}}{\bar{i_s^2}}
\end{equation}
